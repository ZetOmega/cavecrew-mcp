...
| 2 | P1 | IRON: branchmine cluster 2 (38-39,y47-48,59-60) near hub | — | open — CAUTION: sits in/near hazard_branchmine_scar, hit repeated ~10-block VERTICAL false-reach gaps on 3+ candidates when Thak's stray /mine wandered there (see FEEDBACK 12:xx). BariBrute-shaped target (cave-heavy pathing). |
...
| 3b | P1 | COAL RUN: coal = ZERO banked (blocks ALL smelting!) — /mine coal_ore in mine_field zone (93 candidates scanned at x20-29,z63-77), target 64 banked chest D | Grog + UngaBunga | DOING (UngaBunga seconded 12:44Z, north-east part of band ~26,91,72, anti-clump vs Grog's x20-24/z69-72) |
...
| 11 | P2 | BARITONE: role pivot → TUNNEL-BORER. First iron job = 0 iron (Ledger-DB manifest: 11 dirt, 9 dripstone) — legitMine only reaches VISIBLE ore, buried iron honestly unreachable. Navigation PROVEN (790-block return in one goto, y-clamp + no-go held). Next: #tunnel corridors that expose ore for mineflayer miners. Wrapper inventory endpoint = Engineer backlog. | BariBruteDriver | DONE (job) / pivot queued |
